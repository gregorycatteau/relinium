...
### Phase 3 : Registre v1.1

**Livrable** : `docs/_registry/registry_v1.1.yaml`

Structure attendue pour chaque lignée documentaire :
  ...
  - id_root: "ADR-0001"
    versions:
      - id: "ADR-0001"
        status: "Superseded"
        hash: "sha256:..."
        file_path: "docs/03-architecture/decisions/ADR-0001-repo-driven-by-docs-first.md"
      - id: "ADR-0001-v2"
        status: "Active"
        hash: "sha256:..."
        file_path: "docs/03-architecture/decisions/ADR-0001-repo-driven-by-docs-first-v2.md"
...
### Phase 4 : Validation et Traçabilité

**Livrables** :
- `SSOT_V1_1_PROGRESS.yaml` : état du sprint
- `SSOT_V1_1_HASHES.yaml` : hashs de tous les artefacts
...
phases:
  - name: "dry-run"
    status: "completed"
    deliverable: "MIGRATION_DRY_RUN_REPORT.md"
  - name: "execution"
    status: "completed"
    deliverable: "MIGRATION_EXECUTION_REPORT.md"
  - name: "registry"
    status: "completed"
    deliverable: "registry_v1.1.yaml"

documents_migrated:
  - original: "ADR-0001"
    successor: "ADR-0001-v2"
    status: "verified"
  - original: "RFC-001"
    successor: "RFC-001-v2"
    status: "verified"
  - original: "RFC-002"
    successor: "RFC-002-v2"
    status: "verified"
```
...
```yaml
# Hashs des documents originaux (avant migration)
original_hashes:
  ADR-0001: "sha256:..."
  RFC-001: "sha256:..."
  RFC-002: "sha256:..."

# Hashs des documents originaux (après migration - DOIVENT être identiques)
post_migration_hashes:
  ADR-0001: "sha256:..."  # DOIT égaler original_hashes.ADR-0001
  RFC-001: "sha256:..."   # DOIT égaler original_hashes.RFC-001
  RFC-002: "sha256:..."   # DOIT égaler original_hashes.RFC-002

# Hashs des nouveaux successeurs v1.1
successor_hashes:
  ADR-0001-v2: "sha256:..."
  RFC-001-v2: "sha256:..."
  RFC-002-v2: "sha256:..."

# Hashs des rapports de migration
reports:
  dry_run: "sha256:..."
  execution: "sha256:..."
  registry_v1_1: "sha256:..."
```
...
|--------|-------------|--------|------------|
| Modification accidentelle d'un original | Faible | Critique | Capture de hashs avant/après |
| Incohérence dans les liens de succession | Moyenne | Élevé | Validation manuelle systématique |
| Non-conformité au schéma v1.1 | Moyenne | Moyen | Validation avec jsonschema |
